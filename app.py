...
a{color:inherit;text-decoration:none}.wrap{max-width:1160px;margin:0 auto;padding-inline:clamp(24px,5vw,40px)}
header.wrap{min-height:76px;display:flex;align-items:center;justify-content:space-between;border-bottom:1px solid var(--line);padding-block:16px}
...
.hero{display:grid;grid-template-columns:minmax(0,1fr) 390px;gap:84px;padding-block:96px 82px;align-items:center}
...
.section{padding-block:92px}.section-head{display:grid;grid-template-columns:1fr 1fr;gap:70px;margin-bottom:42px}.section h2{font:600 42px/.98 "Space Grotesk",sans-serif;letter-spacing:-2px}.section-intro{color:var(--muted);max-width:390px;font-size:16px}
